...
#
# Поставлено 0.82: самое короткое, при котором все четыре плеча стоят
# ровно на 22.0. Знак легче полной стойки, свойство цело. Хотите всё же
# 0.50 — это одна правка здесь, но с открытыми глазами.
VERT = 0.82
