...
def strip(P, dark=False):
    ...
    Цвет судится здесь, а не на знаке. На знаке акцента один процент, и
    любой сойдёт; на полосе видно, выступает ли ссылка вперёд текста и не
    спорит ли врезка с набором.
    """
