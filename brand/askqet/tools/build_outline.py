...
VARIANTS = {
    "askqet": dict(
        ...
        mark_ink="ink", mark_arrow="accent", mark_ol="accent", mark_w=1.0),
}

# Обводка тоньше — по решению заказчика. И одна на знаке и на слове:
# край в логотипе должен быть один и тот же, иначе знак читается
# жирнее слова. Было 1.5 у слова и 2.2 у знака.
WORD_W = 1.0      # обводка, единиц при штрихе слова 12
