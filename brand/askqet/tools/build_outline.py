...
VARIANTS = {
    "ring": dict(
        title="КОНТУР ПО ЗНАКУ",
        note="Знак серый, вокруг него зелёный контур. Тише всех: цвет "
             "появляется как кайма, а не как пятно.",
        mark_ink="ink", mark_arrow="ink", mark_ol="accent", mark_w=1.9),
    "arrow": dict(
        title="СТРЕЛКА ЛИСТОМ",
        note="Кольцо серое, стрелка светло-зелёная, серая обводка держит "
             "обе. Ближе всего к прежнему знаку и к словам о стрелке.",
        mark_ink="ink", mark_arrow="accent", mark_ol="outline", mark_w=1.5),
    "leaf": dict(
        title="ВЕСЬ ЛИСТ",
        note="Знак целиком светло-зелёный в серой обводке, как и слово. "
             "Самый цельный и самый смелый: логотип становится одним цветом.",
        mark_ink="accent", mark_arrow="accent", mark_ol="outline", mark_w=1.5),
}
