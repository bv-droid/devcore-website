...
Чем это кончилось
  ...
  Лента ОТКЛОНЕНА заказчиком. Она была собрана, принята на словах,
  разведена по всему комплекту — знак, производственные файлы, цвет,
  оснастка, шесть носителей, документ — и на собранном виде отклонена.
  Принятым остаётся прежний знак: две строки в уголках, вырез на конце
  хвоста. Откат сделан целиком, verify.py снова даёт свои числа.

  Что из этого листа остаётся в силе — РАЗБОРКА. Уголки дают +0.040,
  вырез даёт +0.001. Эти числа отклонением не отменяются: они про
  принятый знак, а не про ленту. Задача, которую лента решала неверно,
  никуда не делась и ждёт другого решения.

  Что остаётся в машине начертаний: угол выреза держится при любой ширине
  ленты, ширина буквы считается по нерасширенной ленте, разгон расширения
  укорочен до штриха. При ribbon=1.0 всё это в точности прежнее — оси
  drop и ribbon просто стоят на нуле.
